...
parcelRequire.register("14pgl", function(module, exports) {

$parcel$export(module.exports, "diagram", () => $0c79c2ca9819d2ed$export$6118d022d940d562);
...
var $0c79c2ca9819d2ed$var$parser = function() {
...
$0c79c2ca9819d2ed$var$parser.parser = $0c79c2ca9819d2ed$var$parser;
const $0c79c2ca9819d2ed$var$parser$1 = $0c79c2ca9819d2ed$var$parser;
const $0c79c2ca9819d2ed$var$defaultThemeVariables = (0, $8ZZbk.C)();
class $0c79c2ca9819d2ed$var$QuadrantBuilder {
    constructor(){
    ...
    getDefaultConfig() {
        ...
        return {
            ...
            showYAxis: true,
            showTitle: true,
            chartHeight: ((_a = (0, $8ZZbk.D).quadrantChart) == null ? void 0 : _a.chartWidth) || 500,
            chartWidth: ((_b = (0, $8ZZbk.D).quadrantChart) == null ? void 0 : _b.chartHeight) || 500,
            titlePadding: ((_c = (0, $8ZZbk.D).quadrantChart) == null ? void 0 : _c.titlePadding) || 10,
            titleFontSize: ((_d = (0, $8ZZbk.D).quadrantChart) == null ? void 0 : _d.titleFontSize) || 20,
            quadrantPadding: ((_e = (0, $8ZZbk.D).quadrantChart) == null ? void 0 : _e.quadrantPadding) || 5,
            xAxisLabelPadding: ((_f = (0, $8ZZbk.D).quadrantChart) == null ? void 0 : _f.xAxisLabelPadding) || 5,
            yAxisLabelPadding: ((_g = (0, $8ZZbk.D).quadrantChart) == null ? void 0 : _g.yAxisLabelPadding) || 5,
            xAxisLabelFontSize: ((_h = (0, $8ZZbk.D).quadrantChart) == null ? void 0 : _h.xAxisLabelFontSize) || 16,
            yAxisLabelFontSize: ((_i = (0, $8ZZbk.D).quadrantChart) == null ? void 0 : _i.yAxisLabelFontSize) || 16,
            quadrantLabelFontSize: ((_j = (0, $8ZZbk.D).quadrantChart) == null ? void 0 : _j.quadrantLabelFontSize) || 16,
            quadrantTextTopPadding: ((_k = (0, $8ZZbk.D).quadrantChart) == null ? void 0 : _k.quadrantTextTopPadding) || 5,
            pointTextPadding: ((_l = (0, $8ZZbk.D).quadrantChart) == null ? void 0 : _l.pointTextPadding) || 5,
            pointLabelFontSize: ((_m = (0, $8ZZbk.D).quadrantChart) == null ? void 0 : _m.pointLabelFontSize) || 12,
            pointRadius: ((_n = (0, $8ZZbk.D).quadrantChart) == null ? void 0 : _n.pointRadius) || 5,
            xAxisPosition: ((_o = (0, $8ZZbk.D).quadrantChart) == null ? void 0 : _o.xAxisPosition) || "top",
            yAxisPosition: ((_p = (0, $8ZZbk.D).quadrantChart) == null ? void 0 : _p.yAxisPosition) || "left",
            quadrantInternalBorderStrokeWidth: ((_q = (0, $8ZZbk.D).quadrantChart) == null ? void 0 : _q.quadrantInternalBorderStrokeWidth) || 1,
            quadrantExternalBorderStrokeWidth: ((_r = (0, $8ZZbk.D).quadrantChart) == null ? void 0 : _r.quadrantExternalBorderStrokeWidth) || 2
        };
    }
    getDefaultThemeConfig() {
        return {
            quadrant1Fill: $0c79c2ca9819d2ed$var$defaultThemeVariables.quadrant1Fill,
            quadrant2Fill: $0c79c2ca9819d2ed$var$defaultThemeVariables.quadrant2Fill,
            quadrant3Fill: $0c79c2ca9819d2ed$var$defaultThemeVariables.quadrant3Fill,
            quadrant4Fill: $0c79c2ca9819d2ed$var$defaultThemeVariables.quadrant4Fill,
            quadrant1TextFill: $0c79c2ca9819d2ed$var$defaultThemeVariables.quadrant1TextFill,
            quadrant2TextFill: $0c79c2ca9819d2ed$var$defaultThemeVariables.quadrant2TextFill,
            quadrant3TextFill: $0c79c2ca9819d2ed$var$defaultThemeVariables.quadrant3TextFill,
            quadrant4TextFill: $0c79c2ca9819d2ed$var$defaultThemeVariables.quadrant4TextFill,
            quadrantPointFill: $0c79c2ca9819d2ed$var$defaultThemeVariables.quadrantPointFill,
            quadrantPointTextFill: $0c79c2ca9819d2ed$var$defaultThemeVariables.quadrantPointTextFill,
            quadrantXAxisTextFill: $0c79c2ca9819d2ed$var$defaultThemeVariables.quadrantXAxisTextFill,
            quadrantYAxisTextFill: $0c79c2ca9819d2ed$var$defaultThemeVariables.quadrantYAxisTextFill,
            quadrantTitleFill: $0c79c2ca9819d2ed$var$defaultThemeVariables.quadrantTitleFill,
            quadrantInternalBorderStrokeFill: $0c79c2ca9819d2ed$var$defaultThemeVariables.quadrantInternalBorderStrokeFill,
            quadrantExternalBorderStrokeFill: $0c79c2ca9819d2ed$var$defaultThemeVariables.quadrantExternalBorderStrokeFill
        };
    }
    clear() {
        this.config = this.getDefaultConfig();
    ...
    setConfig(config2) {
        (0, $8ZZbk.l).trace("setConfig called with: ", config2);
        this.config = {
            ...this.config,
            ...config2
        };
    ...
    setThemeConfig(themeConfig) {
        (0, $8ZZbk.l).trace("setThemeConfig called with: ", themeConfig);
        this.themeConfig = {
            ...this.themeConfig,
            ...themeConfig
        };
    ...
    getQuadrantPoints(spaceData) {
        ...
        const xAxis = (0, $9ONqd.scaleLinear)().domain([
            0,
            1
        ]).range([
            quadrantLeft,
        ...
        const yAxis = (0, $9ONqd.scaleLinear)().domain([
            0,
            1
        ]).range([
...
const $0c79c2ca9819d2ed$var$config = (0, $8ZZbk.c)();
function $0c79c2ca9819d2ed$var$textSanitizer(text) {
    return (0, $8ZZbk.d)(text.trim(), $0c79c2ca9819d2ed$var$config);
}
const $0c79c2ca9819d2ed$var$quadrantBuilder = new $0c79c2ca9819d2ed$var$QuadrantBuilder();
function $0c79c2ca9819d2ed$var$setQuadrant1Text(textObj) {
    $0c79c2ca9819d2ed$var$quadrantBuilder.setData({
        quadrant1Text: $0c79c2ca9819d2ed$var$textSanitizer(textObj.text)
    });
}
function $0c79c2ca9819d2ed$var$setQuadrant2Text(textObj) {
    $0c79c2ca9819d2ed$var$quadrantBuilder.setData({
        quadrant2Text: $0c79c2ca9819d2ed$var$textSanitizer(textObj.text)
    });
}
function $0c79c2ca9819d2ed$var$setQuadrant3Text(textObj) {
    $0c79c2ca9819d2ed$var$quadrantBuilder.setData({
        quadrant3Text: $0c79c2ca9819d2ed$var$textSanitizer(textObj.text)
    });
}
function $0c79c2ca9819d2ed$var$setQuadrant4Text(textObj) {
    $0c79c2ca9819d2ed$var$quadrantBuilder.setData({
        quadrant4Text: $0c79c2ca9819d2ed$var$textSanitizer(textObj.text)
    });
}
function $0c79c2ca9819d2ed$var$setXAxisLeftText(textObj) {
    $0c79c2ca9819d2ed$var$quadrantBuilder.setData({
        xAxisLeftText: $0c79c2ca9819d2ed$var$textSanitizer(textObj.text)
    });
}
function $0c79c2ca9819d2ed$var$setXAxisRightText(textObj) {
    $0c79c2ca9819d2ed$var$quadrantBuilder.setData({
        xAxisRightText: $0c79c2ca9819d2ed$var$textSanitizer(textObj.text)
    });
}
function $0c79c2ca9819d2ed$var$setYAxisTopText(textObj) {
    $0c79c2ca9819d2ed$var$quadrantBuilder.setData({
        yAxisTopText: $0c79c2ca9819d2ed$var$textSanitizer(textObj.text)
    });
}
function $0c79c2ca9819d2ed$var$setYAxisBottomText(textObj) {
    $0c79c2ca9819d2ed$var$quadrantBuilder.setData({
        yAxisBottomText: $0c79c2ca9819d2ed$var$textSanitizer(textObj.text)
    });
}
function $0c79c2ca9819d2ed$var$addPoint(textObj, x, y) {
    $0c79c2ca9819d2ed$var$quadrantBuilder.addPoints([
        {
            x: x,
            y: y,
            text: $0c79c2ca9819d2ed$var$textSanitizer(textObj.text)
        }
    ]);
}
function $0c79c2ca9819d2ed$var$setWidth(width) {
    $0c79c2ca9819d2ed$var$quadrantBuilder.setConfig({
        chartWidth: width
    });
}
function $0c79c2ca9819d2ed$var$setHeight(height) {
    $0c79c2ca9819d2ed$var$quadrantBuilder.setConfig({
        chartHeight: height
    });
}
function $0c79c2ca9819d2ed$var$getQuadrantData() {
    const config2 = (0, $8ZZbk.c)();
    const { themeVariables: themeVariables , quadrantChart: quadrantChartConfig  } = config2;
    if (quadrantChartConfig) $0c79c2ca9819d2ed$var$quadrantBuilder.setConfig(quadrantChartConfig);
    $0c79c2ca9819d2ed$var$quadrantBuilder.setThemeConfig({
    ...
    return $0c79c2ca9819d2ed$var$quadrantBuilder.build();
}
const $0c79c2ca9819d2ed$var$parseDirective = function(statement, context, type) {
    (0, $8ZZbk.m).parseDirective(this, statement, context, type);
};
const $0c79c2ca9819d2ed$var$clear = function() {
    $0c79c2ca9819d2ed$var$quadrantBuilder.clear();
    (0, $8ZZbk.v)();
};
const $0c79c2ca9819d2ed$var$db = {
    setWidth: $0c79c2ca9819d2ed$var$setWidth,
    setHeight: $0c79c2ca9819d2ed$var$setHeight,
    setQuadrant1Text: $0c79c2ca9819d2ed$var$setQuadrant1Text,
    setQuadrant2Text: $0c79c2ca9819d2ed$var$setQuadrant2Text,
    setQuadrant3Text: $0c79c2ca9819d2ed$var$setQuadrant3Text,
    setQuadrant4Text: $0c79c2ca9819d2ed$var$setQuadrant4Text,
    setXAxisLeftText: $0c79c2ca9819d2ed$var$setXAxisLeftText,
    setXAxisRightText: $0c79c2ca9819d2ed$var$setXAxisRightText,
    setYAxisTopText: $0c79c2ca9819d2ed$var$setYAxisTopText,
    setYAxisBottomText: $0c79c2ca9819d2ed$var$setYAxisBottomText,
    addPoint: $0c79c2ca9819d2ed$var$addPoint,
    getQuadrantData: $0c79c2ca9819d2ed$var$getQuadrantData,
    parseDirective: $0c79c2ca9819d2ed$var$parseDirective,
    clear: $0c79c2ca9819d2ed$var$clear,
    setAccTitle: $8ZZbk.s,
    getAccTitle: $8ZZbk.g,
...
const $0c79c2ca9819d2ed$var$draw = (txt, id, _version, diagObj)=>{
    var _a, _b, _c;
    ...
    (0, $8ZZbk.l).debug("Rendering quadrant chart\n" + txt);
    ...
    (0, $8ZZbk.i)(svg, height, width, ((_c = conf.quadrantChart) == null ? void 0 : _c.useMaxWidth) || true);
...
const $0c79c2ca9819d2ed$var$renderer = {
    draw: $0c79c2ca9819d2ed$var$draw
};
const $0c79c2ca9819d2ed$export$6118d022d940d562 = {
    parser: $0c79c2ca9819d2ed$var$parser$1,
    db: $0c79c2ca9819d2ed$var$db,
    renderer: $0c79c2ca9819d2ed$var$renderer,
    styles: ()=>""
};
...
//# sourceMappingURL=quadrantDiagram-fd70f2d0.553a050e.js.map
